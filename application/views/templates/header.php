...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/zigzag_style.css'); ?>">
...
<body background="<?php echo base_url('assets/images/BG11.jpg'); ?>"
    style="background-size: cover; background-attachment: fixed; margin: 0;">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="<?php echo base_url(); ?>">ZamanTech</a>
